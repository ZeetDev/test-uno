        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300 text-center">
              ...
              <p className="text-gray-600">
                Easily customize every aspect of your design with UnoCSS's flexible utility classes.
              </p>
            </div>
            {/* Feature 3 */}
            <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300 text-center">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            ...
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-xl border border-white/20">
              ...
              <p className="italic">
                "This platform has transformed our business. The speed and flexibility are unmatched
                in the industry."
              </p>
            ...
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-xl border border-white/20">
              ...
              <p className="italic">
                "As a designer, I appreciate the attention to detail and the clean, modern
                aesthetics this platform provides."
              </p>
              <div className="flex mt-4">
                {[1, 2, 3, 4, 5].map((star) => (
                  <svg
            ...
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-xl border border-white/20">
              ...
              <p className="italic">
                "The development experience is seamless. UnoCSS combined with Next.js is a
